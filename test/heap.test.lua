...
describe("Heap test", function()
  ...
  it("Clear remove all items", function()
    assert.are.equal(myHeap:getSize(), 0)
    myHeap:push(1);
    myHeap:push(2)
    myHeap:push(3);
    ...
    myHeap:clear();
    assert.are.equal(myHeap:getSize(),0);
    assert.are.equal(myHeap:peek(),nil);
    assert.are.equal(myHeap:pop(),nil);
  end)
  ...
  it("Custom compare function", function()
    myHeap:setCompare( function (b,a) return b >= a end )
    myHeap:push(2)
    myHeap:push(500);
    myHeap:push(1);
    myHeap:push(-1);
  ...
  it("Push and compare objects", function()
    myHeap:setCompare(function (obj_a,obj_b)
